...
mixed cmd(string args) {
	...
	//TODO figure out call from connect to encre is not valid
    ...
    write_file("log_gab", "encre.c start cmd "+args+"\n");
	...
	write_file("log_gab", "encre.c creatred folder\n");
