...
static void create() {
	...
	//write_file("log_gab", "classes after load" +Classes+"\n");	
	//cheat a bit here; terebi cannot load dead sould saves
    if( !Classes ){ 
		Classes = ([]);
		AddClass("/secure/cfg/classes/cleric");
		AddClass("/secure/cfg/classes/explorer");
		AddClass("/secure/cfg/classes/fighter");
		AddClass("/secure/cfg/classes/mage");
		AddClass("/secure/cfg/classes/thief");
	};
}

static private void validate() {
   //TODO fix classes validate
